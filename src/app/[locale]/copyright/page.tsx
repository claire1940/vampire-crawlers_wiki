...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Vampire Crawlers Wiki',
    description: 'Copyright and intellectual property information for Vampire Crawlers Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Vampire Crawlers Wiki',
      description: 'Copyright and intellectual property information for Vampire Crawlers Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Vampire Crawlers Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Vampire Crawlers Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Vampire Crawlers Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Vampire Crawlers Developers</strong> - Creators of the Vampire Crawlers game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Vampire Crawlers</strong> - Trademark of the game developers</li>
              <li><strong>Vampire Crawlers Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Vampire Crawlers Wiki.
            </p>
            ...
            <p>
              ...
              Vampire Crawlers Wiki<br />
              Email: <a href="mailto:dmca@vampire-crawlers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@vampire-crawlers.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Vampire Crawlers Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Vampire Crawlers Wiki (vampire-crawlers.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@vampire-crawlers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@vampire-crawlers.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@vampire-crawlers.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@vampire-crawlers.wiki</a>
            </p>
            <p>
